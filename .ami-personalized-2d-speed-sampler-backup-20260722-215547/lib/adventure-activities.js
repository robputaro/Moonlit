...
const SHARED_LIBRARY = [
  ...
  { id: 'story-choice-v1', type: 'story-choice', reusable: true, personalization: 'name-theme', answerKey: false },
  { id: 'sequence-v1', type: 'sequence', reusable: true, personalization: 'none', answerKey: true },
  { id: 'design-v1', type: 'design', reusable: true, personalization: 'name-theme', answerKey: false },
  { id: 'odd-one-v1', type: 'odd-one', reusable: true, personalization: 'none', answerKey: true },
  { id: 'word-code-v1', type: 'word-code', reusable: true, personalization: 'name-theme', answerKey: true },
...
export const ACTIVITY_LIBRARY_VERSION = 'ami-adventure-library-v1';
